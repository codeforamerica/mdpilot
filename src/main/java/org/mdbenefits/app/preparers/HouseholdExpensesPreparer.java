...
public class HouseholdExpensesPreparer implements SubmissionFieldPreparer {
    ...
    public Map<String, SubmissionField> prepareSubmissionFields(Submission submission, PdfMap pdfMap) {
        ...
        if (!householdExpenses.isEmpty() || !householdUtilities.isEmpty()) {
            ...
            // Heating or A/C
            results.put("heatingOrCoolingInd", new SingleField("heatingOrCoolingInd",
                    Boolean.toString(householdUtilities.contains("heating") || householdUtilities.contains("cooling")), null));
            ...
            try {
                ...
                var expensesUtilitiesOther = submission.getInputData()
                        .get("householdUtilitiesExpenseAmount_wildcard_otherUtilitiesExpenses");
