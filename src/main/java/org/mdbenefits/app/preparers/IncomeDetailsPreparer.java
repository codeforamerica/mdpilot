        ...
        if (income != null) {
            ...
            for (int i = 0; i < income.size(); i++) {
                ...
                if (isSelfEmployed) {
                    ...
                    results.put("selfEmploymentName" + i,
                            new SingleField("selfEmploymentName", (String) employeeName, selfEmploymentIdx));
                    results.put("selfEmploymentDesc" + i,
                            new SingleField("selfEmploymentDesc", (String) employerName, selfEmploymentIdx));
                    results.put("selfEmploymentMonthlyIncome" + i,
                            new SingleField("selfEmploymentMonthlyIncome", Double.toString(monthlyIncome), selfEmploymentIdx));
                    results.put("selfEmploymentHoursPerWeek" + i,
                            new SingleField("selfEmploymentHoursPerWeek", (String) hoursPerWeek, selfEmploymentIdx));
                    selfEmploymentIdx++;
                } else {
